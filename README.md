...
- Deployed as a Google Cloud Function triggered by HTTP requests.

**Objective:** This project demonstrates the development and deployment of an HTTP-triggered Cloud Function with the necessary privileges to interact with other Google Cloud services.
...
Clean gcp resource to not incurr further cost by
  - delete service principals crated
  - workflow created
  - cloud run function created
  - Delete storage and storage objects
